...
async function main() {
    ...
    function resolveGroup(key, groupName) {
        if (groupName !== 'sections')
            return groupName;
        if (key.startsWith('wwd_') || key === 'services_list')
            return 'wwd';
        if (key.startsWith('involve_'))
            return 'involve';
        ...
        if (key.startsWith('about_'))
            return 'home'; // homepage about preview block
        if (key.startsWith('services_'))
            return 'home'; // homepage services section
        if (key.startsWith('projects_')) {
            if (key === 'projects_view_all_cta' || key === 'projects_donate_cta')
                return 'home';
            return 'projects';
        }
        if (key.startsWith('events_')) {
            if (key.startsWith('events_section_') || key === 'events_view_all_cta')
                return 'home';
            return 'events';
        }
    ...
    for (const setting of settings) {
        ...
        await prisma.siteSetting.upsert({
            ...
            update: { value: setting.value, type: setting.type, groupName: group },
            create: { ...setting, groupName: group },
        });
    }
    console.log('Site settings seeded.');
    // ── Navigation ──
    const navItems = [
        { id: 'nav-home', label: 'Home', url: '/', sortOrder: 0, location: 'HEADER' },
        { id: 'nav-about', label: 'About Us', url: '/about', sortOrder: 1, location: 'HEADER' },
        { id: 'nav-what-we-do', label: 'What We Do', url: '/what-we-do', sortOrder: 2, location: 'HEADER' },
        { id: 'nav-projects', label: 'Projects', url: '/projects', sortOrder: 3, location: 'HEADER' },
        { id: 'nav-events', label: 'Events', url: '/events', sortOrder: 4, location: 'HEADER' },
        { id: 'nav-insights', label: 'Insights', url: '/insights', sortOrder: 5, location: 'HEADER' },
        { id: 'nav-resources', label: 'Resources', url: '/resources', sortOrder: 6, location: 'HEADER' },
        { id: 'nav-partners', label: 'Partners', url: '/partners', sortOrder: 7, location: 'HEADER' },
        { id: 'nav-gallery', label: 'Gallery', url: '/gallery', sortOrder: 8, location: 'HEADER' },
        { id: 'nav-contact', label: 'Contact', url: '/contact', sortOrder: 9, location: 'HEADER' },
        { id: 'nav-footer-home', label: 'Home', url: '/', sortOrder: 0, location: 'FOOTER' },
        { id: 'nav-footer-about', label: 'About Us', url: '/about', sortOrder: 1, location: 'FOOTER' },
        { id: 'nav-footer-what', label: 'What We Do', url: '/what-we-do', sortOrder: 2, location: 'FOOTER' },
        { id: 'nav-footer-projects', label: 'Projects', url: '/projects', sortOrder: 3, location: 'FOOTER' },
        { id: 'nav-footer-insights', label: 'Insights', url: '/insights', sortOrder: 4, location: 'FOOTER' },
        { id: 'nav-footer-resources', label: 'Resources', url: '/resources', sortOrder: 5, location: 'FOOTER' },
        { id: 'nav-footer-partners', label: 'Partners', url: '/partners', sortOrder: 6, location: 'FOOTER' },
        { id: 'nav-footer-contact', label: 'Contact', url: '/contact', sortOrder: 7, location: 'FOOTER' },
    ];
