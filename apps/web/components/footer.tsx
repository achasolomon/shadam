...
const footerNavigation = {
  ...
  getInvolved: [
    ...
    { label: 'Support Us', href: '/get-involved/support-us' },
  ],
  resources: [
    { label: 'Get Help', href: '/get-help' },
    { label: 'Articles', href: '/insights/articles' },
    { label: 'Stories', href: '/insights/stories' },
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <div className="rounded-lg bg-dark-secondary p-6">
                ...
                <Link href="/get-help" className="mt-4 inline-block">
                ...
                <div className="mt-4 border-t border-dark pt-4">
                  ...
                  <a href="tel:+234XXXXXXXXXX" className="text-sm font-medium text-white">
                    0805 177 2262
                  </a>
                </div>
              </div>
