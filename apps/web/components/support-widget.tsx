...
export function SupportWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
        ...
        <div className="mb-4 w-80 rounded-xl border border-border bg-white shadow-xl">
          <div className="border-b border-border p-4">
            ...
            <p className="mt-1 text-sm text-text-secondary">
              We&apos;re here to listen. Chat with us for mental health support.
            </p>
          </div>
          ...
          <div className="p-4">
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex items-center gap-3 rounded-lg border border-border p-3 transition-colors hover:bg-surface-alt"
              >
              ...
              <a
                href="mailto:support@shedam.org"
                className="flex items-center gap-3 rounded-lg border border-border p-3 transition-colors hover:bg-surface-alt"
              >
            ...
            <div className="mt-4 rounded-lg bg-error/5 p-3">
              <p className="text-xs text-error">
                <strong>In crisis?</strong> If you or someone you know is in immediate danger, please call
      ...
      {/* Tooltip */}
      {!isOpen && (
        <div className="absolute bottom-16 right-0 whitespace-nowrap rounded-lg bg-dark px-3 py-2 text-sm text-white opacity-0 transition-opacity group-hover:opacity-100">
          Need Support?
        </div>
      )}
    </div>
