...
export function EventCountdown() {
  // This will be populated from CMS data
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="mt-2 font-heading text-2xl font-bold text-dark">
                Mental Health Awareness Community Forum
              </h2>
              <div className="mt-3 flex flex-wrap gap-4 text-sm text-text-secondary">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Christ the King Catholic Church, Kubwa, Abuja</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              {[
                ...
                <div key={item.label} className="text-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-primary text-2xl font-bold text-white">
                    {item.value}
                  </div>
